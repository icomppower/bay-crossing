...
| `naip-sf.tif`, `naip-sausalito.tif` | [USDA NAIP](https://naip-usdaonline.hub.arcgis.com/) aerial orthoimagery (USGS The National Map NAIP ImageServer), natural colour resampled to 1 m; each building's roof colour is the median of the pixels inside its footprint | Public domain (US Government work) |
