...
- [ ] G0 Data check — SF building footprints + heights, Sausalito OSM buildings, USGS 3DEP terrain, NOAA bathymetry; scripted, cached, checksummed, licences in CREDITS
